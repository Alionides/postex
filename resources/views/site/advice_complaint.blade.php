                             ...
                             <div class="tab-pane-wrap all-radius">
                                <div class="tab-content clearfix">
                                 ...
                                 <div class="form-group label-floating is-empty">
                                    ...
                                    <textarea class="form-control all-radius description input-tooltip" id="complaint-description" type="text" maxlength="2000" data-validate-type="required"></textarea>
                                    <div class="tooltip-wrap">
                                 ...
                                 <div class=" col-lg-6 col-md-6 col-sm-6 col-xs-12 col-lg-offset-6 col-md-offset-6 col-sm-offset-6">
                                    <div class="form-group">
                                       <button type="button" class="btn all-radius save-contact">Göndər</button>
                                    </div>
                                 </div>
