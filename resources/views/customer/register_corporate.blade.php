...
<html lang="tr" xmlns="http://www.w3.org/1999/xhtml">
   <!-- Mirrored from bireysel.yurticikargo.com/Setting/ConsigneeAddress by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 01 Feb 2022 10:04:20 GMT -->
   <!-- Added by HTTrack -->
   ...
   <body class="special-page">
      ...
      <div class="wrapper">
                              ...
                              <div id="slidemenu" class="nav navbar-nav">
                                 <ul class="depth-1">
                                    ...
                                    <li>
                                       ...
                                       <a class="menu-toggle" href="#"></a>
                                       <ul class="depth-2">
                                          <li><a href="UserInfo.html" class="title">Üyelik Bilgileri</a></li>
                                          <li><a href="AddressList.html" class="title">Adres Defterim</a></li>
                                       </ul>
                                    </li>
                                 </ul>
                              </div>
                     ...
                     <div>
                        <div class="content-wrap">
                           <div class="container-small">
                              <h3 class="slideTitle">Alıcı Adresi</h3>
                              <div class="breadcrumb-wrap">
                                 <div class="row">
                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                       <ul class="list-unstyled">
                                          <li><a href="/assets/login//index.html">Anasayfa</a></li>
                                          <li><a>Ayarlar Tanımlar </a></li>
                                          <li class="active"><a>Alıcı Adresi</a></li>
                                       </ul>
                                    </div>
                                 </div>
                              </div>
         ...
         <script src="/assets/login//Scripts/page/setting-consignee-address3f56.js?v=11"></script>
         <script src="/assets/login//Scripts/service/receiver-address-service3f56.js?v=11"></script>
